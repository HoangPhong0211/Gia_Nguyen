...
<div style="background: white; padding: 30px; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); max-width: 1000px; margin: 0 auto;">
    ...
    <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data" style="font-family: 'Segoe UI', sans-serif;">
        @csrf
        
        <div style="display: grid; grid-template-cols: 2fr 1fr; gap: 30px;">
            <div>
                <div style="margin-bottom: 20px;">
                    <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #475569;">Tiêu đề bài viết</label>
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <textarea id="editor" name="content" style="width: 100%; min-height: 300px; border: 1px solid #cbd5e1; border-radius: 8px;"></textarea>
                </div>
            </div>
            ...
            <div>
                <div style="background: #f8fafc; padding: 20px; border-radius: 10px; border: 1px solid #e2e8f0; margin-bottom: 20px;">
                    <div style="margin-bottom: 20px;">
                        ...
                        <select name="category_id" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px; background: white;">
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <select name="status" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 6px; background: white;">
                ...
                <div style="display: flex; flex-direction: column; gap: 10px;">
                    <button type="submit" style="background: #4f46e5; color: white; padding: 14px; border: none; border-radius: 8px; font-weight: 700; cursor: pointer; transition: 0.3s; font-size: 15px;">
                        <i class="fa-solid fa-check"></i> LƯU BÀI VIẾT
                    </button>
                    <a href="{{ route('admin.posts.index') }}" style="text-align: center; color: #ef4444; padding: 10px; text-decoration: none; font-weight: 600; font-size: 14px; border: 1px solid #fecaca; border-radius: 8px;">
                        Hủy bỏ
                    </a>
                </div>
            </div>
