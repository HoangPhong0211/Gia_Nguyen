            ...
            <div
                ...
                <div style="margin-bottom: 20px;">
                    <label style="display: block; font-weight: 600; margin-bottom: 8px;">Chi tiết hồ sơ công
                        trình</label>
                    <textarea name="description" class="ckeditor" style="width: 100%; min-height: 400px;"></textarea>
                </div>
            </div>
                ...
                <div
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <select name="category" required
                            ...
                            <option value="energy">Lĩnh vực Năng lượng</option>
                            <option value="transport">Hạ tầng Giao thông Trọng điểm</option>
                            <option value="agriculture">Thủy lợi & Nông nghiệp Công nghệ cao</option>
                            <option value="civil-industrial">Công trình Dân dụng & Công nghiệp</option>
                        </select>
                    </div>
